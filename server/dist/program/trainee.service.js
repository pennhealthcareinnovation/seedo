...
let TraineeService = class TraineeService {
    constructor(medhubService, clarityService, prismaService) {
    ...
    async reloadProgramTrainees(programID) {
        ...
        const employeeInfo = await this.clarityService.employeeInfo(trainees.map(trainee => trainee.employeeID));
...
TraineeService = __decorate([
    ...
    __metadata("design:paramtypes", [medhub_service_1.MedhubService,
        clarity_service_1.ClarityService,
